...
public class MyNvWebSocket extends AbstractWebSocket {
    private final WebSocketFactory webSocketFactory = new WebSocketFactory();
    private WebSocket webSocket;

    public MyNvWebSocket(final String url) {
        super(url);
        webSocketFactory.setVerifyHostname(verifyHostname);
        webSocketFactory.setConnectionTimeout(3000);
    }
    ...
    public void connect() throws WebSocketException {
        try {
            ...
            currentWebSocket.addListener(new MyNvWebSocketListener(this));
